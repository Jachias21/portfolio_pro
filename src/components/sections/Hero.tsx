...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    if (typing) {
      ...
      if (i > 0) {
        const t = setTimeout(() => setDisplayed(full.slice(0, i - 1)), 30);
        return () => clearTimeout(t);
      } else {
  ...
  return (
    <section
      ...
      style={{ minHeight: '100dvh', paddingTop: '6rem', paddingBottom: '4rem' }}
    >
      {/* Ambient orbs */}
          ...
          <div>
            ...
            >
              ...
              <span
                ...
                style={{ width: '2px', height: '1.2em', background: 'var(--accent)', borderRadius: '2px' }}
              />
            </motion.div>
