...
export const PROJECTS = [
  {
    ...
    media: [
      { type: 'image' as const, src: '/images/soundwave/SoundWave_Logo_V2.png', alt: 'SoundWave logo' },
      { type: 'image' as const, src: '/images/soundwave/soundwave1.png', alt: 'SoundWave Login' },
      { type: 'image' as const, src: '/images/soundwave/soundwave2.png', alt: 'SoundWave Spotify' },
      { type: 'image' as const, src: '/images/soundwave/soundwave3.png', alt: 'SoundWave UI' },
      { type: 'image' as const, src: '/images/soundwave/soundwave4.png', alt: 'SoundWave playlist' },
      { type: 'image' as const, src: '/images/soundwave/soundwave5.png', alt: 'SoundWave UI Triste' },
      { type: 'image' as const, src: '/images/soundwave/soundwave6.png', alt: 'SoundWave Ajustes' },
      { type: 'image' as const, src: '/images/soundwave/soundwave7.png', alt: 'SoundWave Sign In' },
      { type: 'image' as const, src: '/images/soundwave/soundwave8.png', alt: 'SoundWave escoger canciones' },
    ],
  },
  {
    id: 5,
    ...
    media: [
      { type: 'image' as const, src: '/images/aicolondiagnosis/logo_aicolondiagnosis.png', alt: 'AiColonDiagnosis logo' },
      { type: 'image' as const, src: '/images/aicolondiagnosis/aicolondiagnosis1.png', alt: 'AiColonDiagnosis 1' },
      { type: 'image' as const, src: '/images/aicolondiagnosis/aicolondiagnosis2.png', alt: 'AiColonDiagnosis 2' },
      { type: 'image' as const, src: '/images/aicolondiagnosis/aicolondiagnosis3.png', alt: 'AiColonDiagnosis 3' },
      { type: 'image' as const, src: '/images/aicolondiagnosis/aicolondiagnosis4.png', alt: 'AiColonDiagnosis 4' },
      { type: 'image' as const, src: '/images/aicolondiagnosis/aicolondiagnosis5.png', alt: 'AiColonDiagnosis 5' },
      { type: 'image' as const, src: '/images/aicolondiagnosis/aicolondiagnosis6.png', alt: 'AiColonDiagnosis 6' },
    ],
  },
  {
    id: 2,
